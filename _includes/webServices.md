...
{% if project == 'OrthoMCL' %}
<a href='/a/service/record-types/group/searches/GroupsByEValue/reports/standard?evalue_min=-100&evalue_max=-5&reportConfig={"attributes":["primary_key","number_of_members","evalue"]}
'>https://{{project}}.org/{{webapp}}/service/record-types/group/searches/GroupsByEValue/reports/standard?evalue_min=-100&evalue_max=-5&reportConfig={"attributes":["primary_key","number_of_members","evalue"]}</a>
{% else %}
