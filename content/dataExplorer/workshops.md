...
<head>
  ...
  <title>dataExplorer Workshops</title>
  <style>
  ...
  <div class="page">
    ...
    <div class="ws-card">
      <span class="ws-tag">
        ...
        June 2026 &middot; Buzios, Brazil
      </span>
      <h2 class="ws-title">AccelNet Toxo: data harmonization workshop session</h2>
      <p class="ws-desc">
      ...
      <ul class="ex-list">
        <li class="ex-item">
          ...
          <div class="ex-body">
            ...
            <div class="ex-links">
              <a class="ex-chip" target="_blank" href="{{'/documents/clinEpi/clinEpi_workshops/202210_ASTMH/Part4_eda.pdf' | absolute_url}}">
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><ellipse cx="12" cy="12" rx="9" ry="9"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                Dataset
              </a>
              <a class="ex-chip" target="_blank" href="{{'/documents/clinEpi/clinEpi_workshops/202210_ASTMH/Part4_eda_demo.pdf' | absolute_url}}">
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                Exercise: intro to dataExplorer
              </a>
            </div>
          </div>
        </li>
        <li class="ex-item">
          ...
          <div class="ex-body">
            PCR-RFLP genotypes in <em>T. gondii</em>
            <div class="ex-links">
              <a class="ex-chip" target="_blank" href="{{'/documents/clinEpi/clinEpi_workshops/202210_ASTMH/Part4_eda.pdf' | absolute_url}}">
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><ellipse cx="12" cy="12" rx="9" ry="9"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                Dataset
