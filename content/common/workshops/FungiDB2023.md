      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>         
          <tr>
            ...
            <td><br>
              <a  target="_blank" href="{{'/documents/CACE2023/FungiDB_Transcriptomics.pdf' | absolute_url}}">Advanced search strategies II, cont. </a><br></td>
            <td><br>
              <a  target="_blank" href="{{'/documents/CACE2023/FungiDB_SNPs.pdf' | absolute_url}}">Advanced search strategies III </a><br></td>
          </tr>
          <tr>
            <td>3:30 - 3:40 p.m.<br>
                ACE computer lab and Zoom</td>
