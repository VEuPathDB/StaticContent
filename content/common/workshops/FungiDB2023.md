...
<div class="static-content">
  ...
  <div class="centered-title">        
    ...
    <h4><b>Where:</b> This is a virtual workshop. It can accessed from the computer lab at the African Center of Excellence in Bioinformatics & Data-intensive Sciences (ACE), Uganda (first come first served basis) <b>and</b> on Zoom. The workshop will be delivered via Zoom in its entirety.</h4>          
