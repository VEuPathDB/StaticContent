     ...
     <table class="hor-minimalist-a">
        ...
        <tbody>      
          ...
          <tr>
            ...
            <a target="_blank" href="{{'/documents/2024athens/Exercises_and_documents/WCGNA_intro_demo_UGA_workshop_10m' | absolute_url}}"><b>WGCNA and the Study Explorer slides</b></a>
            </td>
          </tr>
          <tr>
            <td>2:45 pm<br>
