      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>         
          ...
          <tr>
            ...
            <td>Omar Harb</td>
            <td><a  target="_blank" href="{{'/documents/2023athens/Day2_Exercises/10_RNAseq_Mapping_Galaxy_part1_UGA23.pdf' | absolute_url}}"><b>Galaxy Data Import and Workflow Start</b></a></td>
          </tr>
          <tr>
            <td>3:00 p.m.<br>
                Life Sciences C128</td>
