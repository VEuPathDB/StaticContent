...
<details closed>
      ...
      <ul>
        <li><a href="{{'/documents/2023hinxtonfungal/JGI_ManualCuration_2023.pdf' | absolute_url}}">JGI manual curation</a></li>
        <li><a href="{{'/documents/2023hinxtonfungal/VEuPathDB_ Apollo_functional_annotation_26_10_2021.pdf' | absolute_url}}">VEuPathDB/Apollo: functional annotation</a></li>
        <li><a href="{{'/documents/2023hinxtonfungal/VEuPathDB_Apollo_structural_annotation_13_02_2023.pdf' | absolute_url}}">VEuPathDB/Apollo: structural annotation</a></li>
     </ul>
