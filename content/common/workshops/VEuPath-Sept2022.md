    ...
    <table class="hor-minimalist-a">
      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>         
          ...
          <tr>
            <td></td>
            <td>Optional Apollo homework <br><a target="_blank" href="{{'/documents/Sept2022/6b-Apollo_optional_exercise_workshop_answer_key.pdf' | absolute_url}}"><b>Answer key</b></a> </td>
            <td></td>
            <td></td>
          </tr>
          <tr>
