  ...
  <div class="workshop">
   ...
   <p>Expected learning objectives:</p>
    ...
    <ul>
        ...
        <li>Registration will open soon!</li>
        <li>Registration may be made via <b><a href="" target="_blank">this link,</a></b> after which you will be prompted to fill a form (this information is confidential and it helps us know our prospective audience to customize examples and exercises)</li>
      ...
      <p><h2>Lodging</h2></p>
      <p>We have blocks reserved in the University of Notre dame dorms and hotel, please see the AGS website for more information.</p>
