    ...
    <details closed="" open="">
      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>
          ...
          <tr>
            <td>1:00 PM</td>
            <td><br>RNA sequence data analysis Part 1a: DESeq2 and Exporting your data to VectorBase
                <p><br>RNA sequence data analysis Part 2: viewing and analyzing your results, Bam to BigWig (Group Exercise)
