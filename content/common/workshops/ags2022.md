...
<div class="contents">
  ...
  <div class="workshop">
   ...
   <p>Expected learning objectives:</p>
    ...
    <ul>
        ...
        <li>Registration will open soon and may be made via the <a href="https://cvent.me/qvLA93">AGS website</a>. After you complete your registration, you will be prompted to fill an online form (this information is confidential and it helps us know our prospective audience to customize examples and exercises)</li>
 ...
 <br>Philadelphia, PA, USA</p>
    ...
    <details closed="" open="">
      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>
          <tr>
            <td>8:00 am</td>
            <td><p style="color:#303030">Breakfast (provided)</p></td>
            <td><br></td>
          </tr>
          <tr>
            <td>9:00 am</td>
          ...
          <tr>
            <td>10:00 am</td>
            <td><p style="color:#303030">Coffee/Tea Break (provided)</p></td>
            <td></td>
          </tr>
          <tr>
            <td>10:20 am</td>
          ...
          <tr>
            <td>12:00 m </td>
            <td><p style="color:#303030">Lunch (provided)</p></td>
            <td><br></td>
          </tr>
          <tr>
            <td>1:00 pm</td>
     ...
     <br>
      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>
          ...
          <tr>
            <td>1:00 pm</td>
            <td>Functional Genomics 2: Host response data
            </td>
            <td>GIGC</td>
      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>
          ...
          <tr>
            <td>9:00 am</td>
            <td>Manual gene annotation with Apollo 
            </td>
            <td>GIGC, RW
            </td>
    ...
    <img style="width: 40em; margin-top: .5em; margin-left: 4em;" src="{{ "/assets/images/wks_ags2022.png" | absolute_url }}" alt="Logos"/>
