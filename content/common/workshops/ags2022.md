    ...
    <details open>
      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>
          ...
          <tr>
            <td>10:50 am</td>
            <td> <a href="{{'/documents/AGS2022/RNAseq_mapping_Galaxy_AGS_2022.pdf' | absolute_url}}"><b>RNA sequence data analysis via Galaxy, Part II: DESeq2 and Exporting your data to VectorBase</b></a>
            <br>FASTQ Groomer 
                <br>Trimmomatic
                <br>FASTQC
                <br>HISAT2 
