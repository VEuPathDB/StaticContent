    ...
    <details open>
      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>
          ...
          <tr>
            <td>1:00 pm</td>
            <td><a href="{{'/documents/AGS2022/VEuPathDB_RNAseq_Mapping_Galaxy_AGS2022.pdf' | absolute_url}}"><b>RNA sequence data analysis via Galaxy, Part I: Uploading data (Group Exercise)</b></a><br><br>
            <a href="{{'/documents/AGS2022/Galaxy RNAseq groups_AGS.pdf' | absolute_url}}"><b>Galaxy group assignments</b></a></td>
            <td>OSH<br></td>
          </tr>
         <tr>
            <td>1:45 pm</td>
            <td><a href="{{'/documents/AGS2022/Adv_JBrowse_RNAseqII_AGS_2022.pdf' | absolute_url}}"><b>Genome Browser II: Interpreting RNAseq data (Group Exercise)</b></a><br><br>
            <a href="{{'/documents/AGS2022/VectorBaseJbrowseFigS_AGAP004707.pdf' | absolute_url}}"><b>Image of JBrowse view with multiple tracks</b></a></td>
            <td>DSR<br></td>
          </tr>
          <tr>
            <td>2:30 pm </td>
      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>
          ...
          <tr>
            <td>10:50 am</td>
            <td> <a href="{{'/documents/AGS2022/RNAseq_mapping_Galaxy_AGS_2022.pdf' | absolute_url}}"><b>RNA sequence data analysis via Galaxy, Part II: DESeq2 and Exporting your data to VectorBase</b>
            <br>FASTQ Groomer 
                <br>Trimmomatic
                <br>FASTQC
                <br>HISAT2 
          ...
          <tr>
            <td>1:00 pm</td>
            <td>RNA sequence data analysis via Galaxy, Part II (continued): viewing and analyzing your results, Bam to BigWig (Group Exercise)</td>
            <td>OSH<br></td>
          </tr>
          <tr>
            <td>2:30 pm</td>
     ...
     <br>
      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>
          ...
          <tr>
            <td>10:20 am</td>
            <td>RNA sequence data analysis via Galaxy, Part II: Continued <br><br>
            <a href="https://bioc.ism.ac.jp/packages/2.14/bioc/vignettes/DESeq2/inst/doc/beginner.pdf"><b>DEseq2 output</b></a></td>
            <td>OSH<br></td>
          </tr>
          <tr>
            <td>12:00 m</td>
          ...
          <tr>
            ...
            <a href="{{'/documents/AGS2022/PathwaysJune2022.pdf' | absolute_url}}"><b>Metabolic Pathways</b></a> and Host response data</td>
            <td>GIGC</td>
          </tr>
          <tr>
            <td>2:00 pm</td>
      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>
          ...
          <tr>
            ...
            <a href="https://docs.google.com/spreadsheets/d/113Hx-nNT6CGUpH71_kq_K3yrxzcy8bqu/edit?usp=sharing&ouid=109864737831887584200&rtpof=true&sd=true"><b>exercises (sign up sheet)</b></a>. </td>
            <td>GIGC, RW</td>
          </tr>
          <tr>
            <td>10:30 am</td>
