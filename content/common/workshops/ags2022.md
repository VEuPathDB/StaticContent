    ...
    <details open>
      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>
          ...
          <tr>
            <td>9:30 am</td>
            <td>Search: Finding genes (with Site Search
            and BLAST), building search strategies
            and 
            visiting gene pages</td>
            <a href="{{'/documents/AGS2022/OrganismPreferencesJune2022.pdf' | absolute_url}}"><b>Organism Preferences</b></a> <br><br></td>
            <td>GIGC<br></td>
          </tr>
          <tr>
            <td>10:00 am</td>
