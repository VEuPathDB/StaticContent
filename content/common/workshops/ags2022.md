    ...
    <details closed="" open="">
      ...
      <table class="hor-minimalist-a">
        ...
        <tbody>
          ...
          <tr>
            <td>10:50 AM</td>
            <td>RNA sequence data analysis via Galaxy, Part III: DESeq2 and Exporting your data to VectorBase</td>
            <br>FASTQ Groomer 
                <br>Trimmomatic
                <br>FASTQC
                <br>HISAT2 
          ...
          <tr>
            <td>1:00 PM</td>
            <td><br>
                <p><br>RNA sequence data analysis via Galaxy, Part IV: viewing and analyzing your results, Bam to BigWig (Group Exercise)
