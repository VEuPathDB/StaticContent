...
<div class="static-content">
  ...
  <div class="centered">
    ...
    <div id="questions">
      ...
      {% endif %}
      {% unless forloop.last %}{% endunless %}{% endfor %}
        <p>--<b><i>Quotes from <a href="https://static-content.veupathdb.org/documents/PUBLIC_REPORT_VEuPathDB_User_Impact_Sustainability_Survey.pdf">
             user surveys</a> conducted Sept-Dec 2024</b></i>.
        </p>
      </div>
    </div>
