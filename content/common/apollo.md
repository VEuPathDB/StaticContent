...
<div class="eupathdb-Announcement" style="margin: 3px; padding: 0.5em; border-radius: 0.5em; border-width: 1px; border-color: lightgrey; border-style: solid; background: rgb(227, 242, 253); display: block;"><div style="display: flex; justify-content: flex-start; align-items: center;"><span class="fa-stack" style="font-size: 1.2em;"><i class="fa fa-circle fa-stack-2x" style="color: rgb(0, 74, 255);"></i><i class="fa fa-info fa-stack-1x" style="color: white;"></i></span><div style="margin-left: 1em; display: inline-block; width: calc(100% - 5.5em); padding: 8px; vertical-align: middle; color: black; font-size: 1.2em;"><div>Did you know that you can modify gene models using the Apollo tool? Learn more about this in our upcoming Apollo webinar on Wednesday, 25th May 2022. We will highlight some of the key features and functionalities of Apollo. Follow <a target="_blank" href="https://liverpool-ac-uk.zoom.us/meeting/register/tJUucOqorDsoH9R9PXjEZKja-UwLppf0lP5y"> this link to register</a> or access <a target="_blank" href="https://veupathdb.org/veupathdb/app/static-content/webinars.html"> our webinars information page</a>.</div></div><div style="margin-left: auto;"><button class="link" style="color: rgb(124, 124, 124); align-self: flex-start; font-size: 0.8em;"><i class="fa fa-times fa-2x wdk-Icon"> </i></button></div></div></div>
